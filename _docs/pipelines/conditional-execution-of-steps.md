...
When [parallel execution](https://codefresh.io/docs/docs/pipelines/advanced-workflows/#parallel-pipeline-execution) is enabled, the `when:` conditional can be used to set up step dependencies using the `steps:` and `on:` key word. For more information on that, [check the parallel pipeline execution page](https://codefresh.io/docs/docs/pipelines/advanced-workflows/#parallel-pipeline-execution). 
